---
title: 'Assignment 03: Implementing Linear Regression and Gradient Descent Optimization'
...
functions to calculate predictions given a set of weights for a model (they model hypothesis), the mean squared error (MSE) loss function, which we will use
